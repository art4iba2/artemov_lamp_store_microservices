...
Готовый backend-каркас по ТЗ: микросервис товаров и микросервис заказов без аутентификации и авторизации. Операции, которые в будущем будут доступны из панели управления, сейчас открыты через API.
